...
const Details = () => {
  ...
  const deleteuser = async (id) => {
    ...
    if (res2.status === 422 || !deletedata) {
      ...
      // getdata(); since the data is deleted we are not calling it back
      navigate("/")
    }
  };
  ...
  return (
    <div className="container mt-3">
      <h1 style={{ fontWeight: 400 }}>Welcome Partha Mallick</h1>
      ...
      <Card sx={{ maxWidth: 600 }}>
        ...
        <div className="row">
            <div className="left_view col-lg-6 col-md-6 col-12">
                ...
                <p className="mt-3"><WorkIcon/>Occupation: <span>{getuserdata.jobrole}</span></p>
            </div>
